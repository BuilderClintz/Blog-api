...
const { allUsers, login, register, singleUser, updateUser, deleteUser, profilePhotoUploadeCtrl, whoViewMyProfileCtrl, FollowingCtrl, unfollowCtrl, } = require('../Controller/UserCtrl');
